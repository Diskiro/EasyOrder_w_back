                            ...
                            <div className="text-center w-full">
                                ...
                                <div className="grid grid-cols-2 gap-4 w-full bg-[#13161a] p-4 rounded-xl mb-6">
                                    <div className="text-center">
                                        ...
                                        <p className="text-xl font-bold text-white">${Number(session.start_amount).toFixed(2)}</p>
                                    </div>
                                    <div className="text-center">
                    ...
                    <div className="bg-[#1F2329] p-8 rounded-3xl border border-gray-700/50 shadow-xl">
                        ...
                        <div className="space-y-3 text-gray-300">
                            <div className="flex justify-between border-b border-gray-700 pb-2">
                                <span>Inicio:</span>
                                <span className="font-mono text-white">${Number(session.start_amount).toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between border-b border-gray-700 pb-2">
                                <span>Final:</span>
                                <span className="font-mono text-emerald-400">${Number(session.end_amount || 0).toFixed(2)}</span>
                            </div>
